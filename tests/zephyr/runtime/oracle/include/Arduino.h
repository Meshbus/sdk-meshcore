#ifndef FOBE_TESTS_LIB_MESHCORE_BLACKBOX_RUNTIME_ORACLE_INCLUDE_ARDUINO_H_
#define FOBE_TESTS_LIB_MESHCORE_BLACKBOX_RUNTIME_ORACLE_INCLUDE_ARDUINO_H_
...
#endif /* FOBE_TESTS_LIB_MESHCORE_BLACKBOX_RUNTIME_ORACLE_INCLUDE_ARDUINO_H_ */
