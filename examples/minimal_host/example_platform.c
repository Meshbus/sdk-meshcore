/*
 * Link/init demonstration only. The RNG, digest, AES, HMAC, identity,
 * clock, timer and radio implementations below are deterministic placeholders.
 * They provide no packet confidentiality or authenticity and do not operate
 * hardware. Replace them before using this host outside the package smoke test.
 * See README.md in this directory for the replacement checklist.
 */
#include <errno.h>
#include <stdbool.h>
#include <stddef.h>
